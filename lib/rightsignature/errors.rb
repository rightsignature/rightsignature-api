class RightSignature::ResponseError < Exception
...
class RightSignature::TokenResponseError < Exception; end
class RightSignature::OAuthResponseError < Exception; end
